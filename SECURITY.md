...
uses Tie::Hash::DBD, or plugins to it that are not included with the
Tie::Hash::DBD distribution) are not covered by this policy.

## Supported Versions of Tie::Hash::DBD

The maintainer(s) will only commit to releasing security fixes for
the latest version of Tie::Hash::DBD.

Note that the Tie::Hash::DBD project only supports major versions of Perl
released in the past 5 years, even though Tie::Hash::DBD will run on
...
prerequisites that are required for Tie::Hash::DBD to work.  However, some
